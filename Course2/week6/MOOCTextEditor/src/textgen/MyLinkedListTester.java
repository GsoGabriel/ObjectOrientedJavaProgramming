...
public class MyLinkedListTester {
	...
	public void testSet()
	{
		...
		assertEquals("AddAtIndex: Check if list2 changed correctly the position", (Integer)65, list2.get(0));
		assertEquals("AddAtIndex: Check if list2 changed correctly the position", (Integer)25, list2.get(1));
		assertEquals("AddAtIndex: Check if list2 set at correct position", (Integer)598, list2.get(2));
	}
